...
save_results(all_results, 'section1_3', output_dir='sec3_results', epochs=epochs, device=device,
             grids=grids, depths=depths, activations=activations, num_datasets=len(datasets))